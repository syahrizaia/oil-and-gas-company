...
// Begin JS library code
  ...
  function _SendObjectIdToReact(str) {
      ...
      var idString = UTF8ToString(str);
      
      // Panggil fungsi dispatchReactUnityEvent yang disediakan oleh package react-unity-webgl
      if (typeof window.dispatchReactUnityEvent !== "undefined") {
        window.dispatchReactUnityEvent("OnObjectSelected", idString);
      } else {
        console.warn("React Unity Event listener tidak ditemukan di browser.");
      }
    }
